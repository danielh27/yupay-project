...
5.times do
  new_order = Order.new(status: true, customer_id: 3, user_id:1, created_at: 8.days.ago, updated_at: 7.days.ago)
  new_order.save!
...
5.times do
  new_purchase = Purchase.new(status: true, supplier_id: 3, user_id:1, created_at: 3, updated_at: 3.days.ago)
  new_purchase.save!
