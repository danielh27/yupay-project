class Product < ApplicationRecord
  ...
  validates :price, presence: true, numericality: { only_integer: true, greather_than: 0 }
  validates :cost, presence: true, numericality: { only_integer: true, greather_than: 0 }
